...
SYSTEM_KEY_EXPECTATIONS = {
    ...
    "Spell/&DominateBeastTitle": "野獣支配",
    "Spell/&DreadfulOmenTitle": "凶兆",
    "Spell/&FeeblemindTitle": "知能低下",
    "Spell/&FingerOfDeathTitle": "死神の指",
    "Spell/&HuntersMarkTitle": "狩人の印",
    "Spell/&AlarmTitle": "警報",
    "Spell/&CausticZapTitle": "腐食電撃",
    "Spell/&CircleOfMagicalNegationTitle": "力の円環",
    "Spell/&DemiplaneTitle": "擬似次元界",
    "Spell/&FlameStrikeTitle": "天罰の火",
    "Spell/&FlamingSphereTitle": "炎の球体",
    "Spell/&Floating DiskTitle": "浮遊盤",
    "Spell/&GreaterInvisibilityTitle": "上級不可視化",
    "Spell/&MaledictionTitle": "悪呪",
    "Spell/&PulseWavePullTitle": "脈波（引き寄せ）",
    "Spell/&PulseWavePushTitle": "脈波（押し出し）",
    "Spell/&PulseWaveTitle": "脈波",
    "Spell/&SkinOfRetributionTitle": "アガシスの鎧",
    "Spell/&PsychicWhipTitle": "ターシャの精神の鞭",
    "Condition/&ConditionSkinOfRetributionTitle": "アガシスの鎧",
    "Condition/&ConditionPsychicWhipNoReactionTitle": "ターシャの精神の鞭",
    "Spell/&EnhanceAbilityFoxsCunningTitle": "狐の知力",
    "Spell/&EnhanceAbilityOwlsWisdomTitle": "梟の判断力",
    "Spell/&EnhanceAbilityCatsGraceTitle": "猫の敏捷力",
    "Spell/&EnhanceAbilityEaglesSplendorTitle": "鷲の魅力",
    "Spell/&EnhanceAbilityBearsEnduranceTitle": "熊の耐久力",
    "Spell/&EnhanceAbilityBullsStrengthTitle": "雄牛の筋力",
    "Spell/&VenomousSpikeTitle": "毒針",
    "Spell/&VampiricTouchTitle": "吸血の手",
    "Spell/&SymbolTitle": "印形",
    "Spell/&AnnoyingBeeTitle": "幻蜂",
    "Spell/&ArcaneSwordTitle": "秘術の剣",
    "Spell/&BlackTentaclesTitle": "エヴァードの黒い触手",
    "Spell/&ChaosBoltTitle": "混沌の矢",
    "Spell/&CircleOfDeathTitle": "死の円環",
    "Spell/&DivineBladeTitle": "神剣",
    "Spell/&DivineFavorTitle": "神寵",
    "Spell/&ElementalInfusionTitle": "元素吸収",
    "Spell/&GiantInsectTitle": "蟲類巨大化",
    "Spell/&GravitySlamTitle": "重力撃",
    "Spell/&MazeTitle": "迷路",
    "Spell/&MindTwistTitle": "精神ねじり",
    "Spell/&MoonBeamTitle": "月光",
    "Spell/&ShieldOfFaithTitle": "信仰の盾",
    "Spell/&Shine_Title": "発光",
    "Spell/&Sparkle_Title": "きらめき",
    "Spell/&SynapticStaticTitle": "脳神経抑圧",
    "Spell/&ThunderstormTitle": "雷雨",
    "Spell/&VileBrewTitle": "ターシャのコースティック・ブリュー",
    "Spell/&WallOfThornsTitle": "イバラの壁",
    "Spell/&WallOfThornsLineTitle": "イバラの壁（直線）",
    "Spell/&WallOfThornsRingTitle": "イバラの壁（輪）",
    "Spell/&WindWallTitle": "風の壁",
    "Size/&GargantuanTitle": "巨大",
    "Size/&HugeTitle": "超大型",
    "Reaction/&ReactionAttackAoOEnterTitle": "機会攻撃",
    "Reaction/&AlterAttackSpellReactTitle": "呪文",
    "Reaction/&CastFallPreventionSpellReactTitle": "呪文",
    "Reaction/&CastImmunityToSpellReactTitle": "呪文",
    "Reaction/&CastSpellInRetributionReactTitle": "呪文",
    "Reaction/&ReactionShotTitle": "反応射撃",
    "Reaction/&CounterSpellReactTitle": "呪文妨害",
    "Reaction/&GiantKillerTitle": "巨人殺し",
    "Reaction/&SpendPowerPowerPatronHiveMagicCounterReactTitle": "呪文妨害",
    "Action/&RageStartTitle": "激怒",
    "Action/&DodgeTitle": "回避",
    "Action/&BreakFreeTitle": "脱出",
    "Action/&EldritchVersatilityTitle": "術式",
    "Action/&RecallItemTitle": "アイテム回収",
    "Feature/&GambitParryTitle": "受け流し",
    "Feature/&ActionAffinityMarksmanReactionShotTitle": "反応射撃",
    "Feature/&DomainMischiefStrikeOfChaosTitle": "神性伝導：混沌の一撃",
    "Feature/&DomainMischiefStrikeOfChaosShortTitle": "混沌の一撃",
    "Feature/&DomainMischiefStrikeOfChaosAdvancedTitle": "混沌の一撃（上級）",
    "Feature/&PowerTraditionOpenHandOpenHandTechniqueDazzleTitle": "幻惑",
    "Feature/&UncannyDodgeTitle": "直感回避",
    "Feature/&ActionAffinityHunterGiantKillerTitle": "巨人殺し",
    "Feature/&PowerBardHeroismAtRoadsEndTitle": "旅路の果て",
    "Action/&SpiritRallyTitle": "精魂招集",
    "Feat/&ArmorMasterTitle": "防具の達人",
    "Feature/&PowerEldritchVersatilityPointPoolTitle": "妖術術式",
    "Feat/&FeatEldritchVersatilityAdeptTitle": "妖術術式の達人",
    "Feature/&MetamagicSeekingSpellTitle": "追尾呪文",
    "Reaction/&CustomReactionMetamagicSeekingSpellTitle": "追尾呪文",
    "Reaction/&CustomReactionMetamagicSeekingSpellReactTitle": "追尾呪文",
    "Failure/&FailureSeekingSpell": "追尾呪文は呪文攻撃が外れた後にのみ使用できます",
    "Feature/&PowerKnightParryTitle": "受け流し",
    "Feature/&PowerMarilithParryTitle": "受け流し",
    "Feature/&PowerPatronHiveMagicCounterTitle": "呪文妨害",
    ...
    "Rules/&ConditionDazzledTitle": "幻惑",
    "Rules/&ConditionSorcererChildRiftDeflectionTitle": "裂け目偏向",
    ...
    "Tooltip/&TagAttunementTitle": "同調",
    "Equipment/&DeviceRequiresAttunementTitle": "同調が必要（小休憩）",
    "Action/&ActionGrappleTitle": "組みつき",
    "Action/&ActionDisableGrappleTitle": "組みつきを解除",
    "Action/&FlightSuspendTitle": "飛行を一時停止",
    "Condition/&FlightSuspendTitle": "飛行停止",
    "Feature/&FlightSuspendTitle": "飛行を一時停止",
    "Invocation/&RepellingBlastTitle": "拒絶の怪光線",
    "Feature/&FeatureRangerGloomStalkerShadowyDodgeTitle": "朧影",
    "Reaction/&UncannyDodgeTitle": "直感回避",
    "Race/&ElfTitle": "エルフ",
    "CharacterTemplate/&RosLastName": "ロス",
    "Prop/&CellTitle": "マス",
    "Reaction/&DeflectMissileMonkTitle": "矢止め",
    "Reaction/&DeflectMissileTitle": "矢止め",
    "Reaction/&ReturnMissileTitle": "矢返し",
    "Reaction/&PassTitle": "見送る",
    "Screen/&PassTitle": "スキップ",
    "Feature/&FeatureEldritchMasterTitle": "呪文復活",
    "Feature/&PowerWarlockEldritchMasterTitle": "呪文復活",
    "Feat/&FeatGroupPlaneMagicTitle": "次元魔法",
    "Action/&CastPlaneMagicTitle": "次元魔法を行使",
    "Encounter/&CR10_DragonDuo_Huge_Title": "双竜",
    "Invocation/&InvocationAspectOfTheMoonTitle": "観月",
    "Invocation/&InvocationEldritchMindTitle": "妖術の心",
    "Feature/&AttackModifierHitAndDamagePlus1Title": "契約武器強化",
    "Invocation/&InvocationImprovedPactWeaponTitle": "契約武器強化",
    "Feature/&DomainElementalLightningBonusCantripTitle": "ボーナス初級呪文（電撃）",
    "Feature/&PowerInnovationAlchemyMarkerDamageLightningTitle": "電撃爆弾",
    "Feedback/&ExtraDamageTitle": "電撃の槍の追加ダメージ",
    "Feat/&FeatTripAttackTitle": "足払い",
    "Rules/&ConditionFeatRaiseShieldTitle": "盾を構えた",
    "Rules/&ConditionFeatRushToBattleTitle": "戦場への突進",
    "Rules/&ConditionFeatTwinBladeTitle": "双刃防御",
    "EffectProxy/&ProxySleetStormDescription": "みぞれ混じりの嵐",
    "EffectProxy/&ProxySpiritualWeaponTitle": "心霊武器",
    "Item/&CELightningLauncherTitle": "稲妻投射器",
    "Feature/&DomainElementalLightningBladeTitle": "神性伝導：電撃の刃",
    "Feature/&PowerDragonbornBreathWeaponBlueTitle": "ブレスウェポン - 電撃の直線",
    "Feature/&PowerStormGiantLightingBolt_Title": "電撃",
    "Spell/&BeaconOfHopeTitle": "希望のともしび",
    "Rules/&ConditionBeaconOfHopeTitle": "希望のともしび",
    "Monster/&Acolyte_Title": "侍祭",
    "Monster/&Archmage_Title": "大魔道士",
    "Monster/&InvisibleStalker_Title": "インヴィジブル・ストーカー",
    "Quest/&Cradle_Of_Fire_Quest_06_KillRedscarOrcsTitle": "レッドスカー族のオークを倒す",
    "Encounter/&BadlandsSpidersEncounterTitle": "バッドランズ・スパイダー",
    "Background/&AcolyteTitle": "侍祭",
    "NPC/&NPC_NecromancerAcolyteTitle": "ネクロマンサーの侍祭",
    ...
    "Rules/&ConditionDivineFavorTitle": "神寵",
    "Rules/&ConditionShieldedByKnightParryTitle": "受け流し",
    "Rules/&ConditionShieldedByMarilithParryTitle": "受け流し",
    "Rules/&ConditionVampiricTouchTitle": "吸血の手",
    "Tooltip/&TagDamageChaosBoltTitle": "混沌ダメージ",
}
...
MANUAL_BANNED_PATTERNS = [
    ...
    (lambda key: "SkinOfRetribution" in key, re.compile(r"アガティスの鎧|アーマー・オブ・アガティス"), "アガシスの鎧"),
    (lambda key: "PsychicWhip" in key, re.compile(r"ターシャのマインドウィップ"), "ターシャの精神の鞭"),
    (lambda key: "AuraOfVitality" in key or "MustBeAuraOfLife" in key, re.compile(r"オーラ・オブ・バイタリティ"), "活力のオーラ"),
    (lambda key: "PulseWave" in key, re.compile(r"パルス波|脈波：プル|脈波：プッシュ|パルス波："), "脈波"),
    (lambda key: "CausticZap" in key, re.compile(r"カウスティック(?:・|)ザップ|コースティック(?:・|)ザップ"), "腐食電撃"),
    (lambda key: "Malediction" in key, re.compile(r"マレディクション"), "悪呪"),
    (lambda key: "Demiplane" in key, re.compile(r"デミプレーン|デミプレイン"), "擬似次元界"),
    (lambda key: "GreaterInvisibility" in key, re.compile(r"グレーター・インビジぶりティ|グレーター・インビジ(?:ビ|ぶ)リティ"), "上級不可視化"),
    (lambda key: "FlameStrike" in key, re.compile(r"フレイム・ストライク"), "天罰の火"),
    (lambda key: "FlamingSphere" in key, re.compile(r"フレイミング・スフィアー"), "炎の球体"),
    (lambda key: "Floating Disk" in key or "FloatingDisk" in key, re.compile(r"フローティング・ディスク"), "浮遊盤"),
    (lambda key: "FoxsCunning" in key, re.compile(r"フォックスの狡猾さ"), "狐の知力"),
    (lambda key: "OwlsWisdom" in key, re.compile(r"フクロウの判断力"), "梟の判断力"),
    (lambda key: "CatsGrace" in key, re.compile(r"キャッツグレース"), "猫の敏捷力"),
    (lambda key: "EaglesSplendor" in key, re.compile(r"イーグルの素晴らしさ"), "鷲の魅力"),
    (lambda key: "BearsEndurance" in key, re.compile(r"クマの耐久力"), "熊の耐久力"),
    (lambda key: "VenomousSpike" in key or "VenomSpike" in key, re.compile(r"ベノム・スパイク"), "毒針"),
    (lambda key: "VampiricTouch" in key, re.compile(r"ヴァンピリック・タッチ|ヴァンパイア(?:リック)?・タッチ"), "吸血の手"),
    (lambda key: key == "Spell/&SymbolTitle" or key.startswith("Equipment/&ScrollSymbol"), re.compile(r"シンボル"), "印形"),
    (lambda key: "CircleOfMagicalNegation" in key, re.compile(r"パワーの輪|サークル・オヴ・パワー"), "力の円環"),
    (lambda key: "Parry" in key, re.compile(r"パリー|パリィ"), "受け流し"),
    (lambda key: True, re.compile(r"バード(?:ィック)? インスピレーション"), "バードの声援 / 声援ダイス"),
    (lambda key: True, re.compile(r"レイジダメージ"), "激怒ダメージ"),
    (lambda key: True, re.compile(r"気 ポイント"), "気ポイント"),
    (lambda key: True, re.compile(r"ダッシュ アクション"), "ダッシュ・アクション"),
    (lambda key: True, re.compile(r"初級呪文呪文"), "初級呪文"),
    (lambda key: True, re.compile(r"デミプレーン"), "擬似次元界"),
    (lambda key: key in {"Action/&RageStartTitle", "Feature/&FeatureSetRageTitle", "Action/&SpiritRageTitle", "Feature/&FeatureSetSpiritRageTitle", "Feat/&FeatGroupPrimalRageTitle", "Feat/&FeatPrimalRageConTitle", "Feat/&FeatPrimalRageStrTitle"}, re.compile(r"レイジ|怒り"), "激怒"),
    (lambda key: key == "Reaction/&CastSpellInRetributionReactTitle", re.compile(r"おまじない"), "呪文"),
    (lambda key: "ReactionShot" in key, re.compile(r"リアクションショット"), "反応射撃"),
    (lambda key: "RecallItem" in key, re.compile(r"アイテムのリコール"), "アイテム回収"),
    (lambda key: "StrikeOfChaos" in key, re.compile(r"ストライク・オブ・カオス|Strike of Chaos"), "混沌の一撃"),
    (lambda key: "Dazzle" in key or "Dazzled" in key, re.compile(r"ダズル|眩しい"), "幻惑"),
    (lambda key: "AspectOfTheMoon" in key, re.compile(r"月のアスペクト"), "観月"),
    (lambda key: "EldritchMind" in key, re.compile(r"エルドリッチ・マインド"), "妖術の心"),
    (lambda key: "SpiritRally" in key, re.compile(r"スピリットラリー"), "精魂招集"),
    (lambda key: "DragonDuo" in key, re.compile(r"ドラゴンデュオ"), "双竜"),
    (lambda key: "PactWeapon" in key or "PactOfTheBlade" in key or "SoulBladeSummonPactWeapon" in key, re.compile(r"パクトウェポン|パクト・オブ・ブレイド|霊的契約の武器"), "契約武器 / 剣の契約 / 霊的契約武器"),
    (lambda key: "RepellingBlast" in key, re.compile(r"弾くブラスト"), "拒絶の怪光線"),
    (lambda key: "UncannyDodge" in key, re.compile(r"不気味な回避"), "直感回避"),
    (lambda key: "ShadowyDodge" in key, re.compile(r"影の回避|シャドウドッジ"), "朧影"),
    (lambda key: "Attunement" in key, re.compile(r"アチューンメント"), "同調"),
    (lambda key: key in {"Rules/&AlignmentTitle", "Rules/&AlignmentDescription", "Stage/&BackgroundAlignmentTitle", "Stage/&BackgroundSelectionStageMissingAlignmentDescription"}, re.compile(r"位置合わせ|配置|アライメント"), "属性"),
    (lambda key: "Deflection" in key, re.compile(r"ディフレクション|たわみ"), "偏向"),
    (lambda key: "LayOnHands" in key or "RestoringTouch" in key or "EnablePaladinLayOnHands2024" in key, re.compile(r"レイ ?オン ?ハンズ|Lay on Hands"), "癒しの手"),
    (lambda key: key in {"Action/&DodgeTitle", "Feature/&UncannyDodgeTitle", "Reaction/&UncannyDodgeTitle"}, re.compile(r"ドッジ"), "回避 / 直感回避"),
    (lambda key: "FeatureSetRangerHunterSuperiorHuntersDefenseChoiceDescription" in key, re.compile(r"Stand Against the Tide|Evasion|Uncanny Dodge"), "流れに立ち向かう / 回避 / 直感回避"),
    (lambda key: "PowerWarMagicDeflectionShroud" in key, re.compile(r"秘術偏向"), "跳ね返しの秘術"),
    (lambda key: "GiantKiller" in key, re.compile(r"でかぶつ殺し|ジャイアントキラー"), "巨人殺し"),
    (lambda key: "PatronHiveMagicCounter" in key, re.compile(r"マジック ?カウンター(?: ?パワー)?"), "呪文妨害"),
    ...
    (lambda key: "DominateBeast" in key, re.compile(r"ドミネート・ビースト|ドミネイト・ビースト"), "野獣支配"),
    (lambda key: "DreadfulOmen" in key, re.compile(r"ドレッドフル・オーメン|恐ろしい予兆"), "凶兆"),
    (lambda key: "Feeblemind" in key, re.compile(r"フィーブルマインド"), "知能低下"),
    (lambda key: "FingerOfDeath" in key, re.compile(r"フィンガー・オブ・デス|フィンガー・オヴ・デス|死の指"), "死神の指"),
    (lambda key: "HuntersMark" in key or "Hunter's Mark" in key or "MarkedByHunter" in key, re.compile(r"ハンターズ・マーク|ハンターズマーク|ハンターのマーク|Hunter's Mark"), "狩人の印"),
    (lambda key: "Alarm" in key, re.compile(r"アラーム"), "警報"),
    (lambda key: "AnnoyingBee" in key, re.compile(r"アノイング・ビー"), "幻蜂"),
    (lambda key: "ArcaneSword" in key, re.compile(r"アーケイン(?: |・)?ソード"), "秘術の剣"),
    (lambda key: "BlackTentacles" in key, re.compile(r"ブラック・テンタクル|(?<!エヴァードの)黒い触手"), "エヴァードの黒い触手"),
    (lambda key: "ChaosBolt" in key, re.compile(r"ケイオス・ボルト|カオス(?:・|)ボルト"), "混沌の矢"),
    (lambda key: "CircleOfDeath" in key, re.compile(r"サークル・オブ・デス|死の輪"), "死の円環"),
    (lambda key: "DivineBlade" in key, re.compile(r"ディ(?:ヴァ|バ)イン・ブレード"), "神剣"),
    (lambda key: "DivineFavor" in key, re.compile(r"ディ(?:ヴァ|バ)イン・フェイ(?:ヴァ|バー)|神の恩寵|神の好意"), "神寵"),
    (lambda key: "ElementalInfusion" in key, re.compile(r"要素を吸収する|エレメントを吸収(?:せよ)?|エレメントアタック到来"), "元素吸収"),
    (lambda key: "GiantInsect" in key, re.compile(r"ジャイアント・インセクト|巨大昆虫"), "蟲類巨大化"),
    (lambda key: "GravitySlam" in key, re.compile(r"グラビティ・スラム|重力スラム"), "重力撃"),
    (lambda key: "MindTwist" in key, re.compile(r"マインド(?:・| )ツウィスト|マインド(?:・| )ツイスト"), "精神ねじり"),
    ...
    (lambda key: "MoonBeam" in key, re.compile(r"ムーン(?:・|)ビーム"), "月光"),
    (lambda key: "ShieldOfFaith" in key, re.compile(r"シールド・オヴ・フェイス"), "信仰の盾"),
    (lambda key: "Shine" in key, re.compile(r"シャイン"), "発光"),
    (lambda key: "Sparkle" in key, re.compile(r"スパークル"), "きらめき"),
    ...
    (lambda key: "SynapticStatic" in key, re.compile(r"シナプススタティック"), "脳神経抑圧"),
    (lambda key: "Thunderstorm" in key, re.compile(r"サンダーストーム"), "雷雨"),
    ...
    (lambda key: "VileBrew" in key, re.compile(r"ターシャのコースティック ブリュー"), "ターシャのコースティック・ブリュー"),
    ...
    (lambda key: "WindWall" in key, re.compile(r"ウィンド・ウォール"), "風の壁"),
    ...
    (
        ...
        re.compile(r"異界の汎用性|エルドリッチ・バーサティリティ|バーサティリティ(切替)?|エルドリッチ・プール|エルドリッチ・ポイント|汎用性(?!の達人)|汎用性切替"),
        "妖術術式 / 術式 / 術式切替 / 妖術プール / 妖術点",
    ),
    (
        lambda key: "SeekingSpell" in key,
        re.compile(r"シーキング・スペル"),
        "追尾呪文",
    ),
    (lambda key: "BeaconOfHope" in key, re.compile(r"ビーコン・オブ・ホープ|希望の灯台"), "希望のともしび"),
    (
        lambda key: "DeflectMissile" in key or "ReturnMissile" in key,
        re.compile(r"ミサイル"),
        "矢止め / 矢返し / 飛び道具",
    ),
    (
        lambda key: key == "Reaction/&PassTitle",
        re.compile(r"パス"),
        "見送る",
    ),
    (
        lambda key: "Acolyte" in key and key.startswith(("Monster/", "Background/", "NPC/")),
        re.compile(r"アコライト"),
        "侍祭",
    ),
    (
        lambda key: "Archmage" in key,
        re.compile(r"アークメイジ"),
        "大魔道士",
    ),
    (
        lambda key: "InvisibleStalker" in key,
        re.compile(r"見えないストーカー"),
        "インヴィジブル・ストーカー",
    ),
    (
        lambda key: "Redscar" in key and "Orc" in key,
        re.compile(r"レッドスカー オーク"),
        "レッドスカー族のオーク",
    ),
    (
        lambda key: "BadlandsSpider" in key or key.endswith("SpiderTitle"),
        re.compile(r"バッドランズ スパイダー"),
        "バッドランズ・スパイダー",
    ),
    (
        lambda key: "FlightSuspend" in key,
        re.compile(r"フ光|運航停止|(?<!飛行を一時停止)土地"),
        "飛行を一時停止 / 飛行停止",
    ),
    (
        lambda key: "ActionGrapple" in key or "ConditionGrapple" in key,
        re.compile(r"グラップル|グラップリング"),
        "組みつき / 組みつき中 / つかまれた状態",
    ),
    (
        lambda key: "PlaneMagic" in key,
        re.compile(r"プレーンマジック|Plane Touched|チャンネルプレーンマジック"),
        "次元魔法 / 次元魔法を行使",
    ),
    (
        lambda key: "EldritchMaster" in key,
        re.compile(r"エルドリッチマスター|異界のマスター"),
        "呪文復活",
    ),
    ...
    (lambda key: "DauntingPush" in key, re.compile(r"恐るべきプッシュ"), "威圧の押し出し"),
    (lambda key: "MasterAlchemist" in key, re.compile(r"マスターアルケミスト"), "錬金術の達人"),
    (lambda key: "ForestRunner" in key, re.compile(r"フォレストランナー"), "森渡り"),
    (lambda key: "RaiseShield" in key, re.compile(r"レイズシールド|上げられた盾"), "盾を構える / 盾を構えた"),
    (lambda key: "RushToBattle" in key, re.compile(r"戦闘へ急ぐ|戦いへ急ぐ"), "戦場への突進"),
    (lambda key: "TwinBlade" in key, re.compile(r"ツインブレード"), "双刃 / 双刃防御"),
    (lambda key: "Lockbreaker" in key or "LockBreaker" in key, re.compile(r"ロックブレイカー"), "錠破り"),
    (lambda key: "MightyBlow" in key, re.compile(r"マイティブロー"), "豪打"),
    (lambda key: "BurningTouch" in key, re.compile(r"バーニングタッチ"), "火炎の手"),
    (lambda key: "IcyTouch" in key, re.compile(r"アイシータッチ|氷の接触"), "氷の手"),
    (lambda key: "MeltingTouch" in key, re.compile(r"とろけるタッチ"), "溶解の手"),
    (lambda key: "ToxicTouch" in key, re.compile(r"トキシックタッチ|Toxic Touch"), "毒の手"),
    (lambda key: "ElectrifyingTouch" in key, re.compile(r"電撃の手|電撃タッチ|感電タッチ|しびれるようなタッチ"), "帯電打撃"),
    (lambda key: key == "Feat/&ArmorMasterTitle", re.compile(r"重装鎧の達人|アーマーマスター"), "防具の達人"),
    (lambda key: "LightningLauncher" in key, re.compile(r"ライトニング ?ランチャー"), "稲妻投射器"),
    (lambda key: "LightningBonusCantrip" in key or "DomainElementalLightningBonusCantrip" in key, re.compile(r"ライトニング"), "電撃"),
    (lambda key: "MarkerDamageLightning" in key, re.compile(r"ライトニングボム"), "電撃爆弾"),
    (lambda key: "ExtraDamageTitle" in key or "ExtraDamageDescription" in key, re.compile(r"ライトニングスピア"), "電撃の槍"),
    ...
    (lambda key: True, re.compile(r"ガルガンチュアン"), "巨大"),
