...
- Translate Seeking Spell as 追尾呪文, Plane Magic as 次元魔法, Channel Plane Magic as 次元魔法を行使, grapple as 組みつき, grappling as 組みつき中, grappled as つかまれた状態, Flight Suspended as 飛行停止, Suspend Flight as 飛行を一時停止, Magical Cunning as 魔法の狡猾さ, and Eldritch Master as 呪文復活 in system text.
