...
public sealed class CollegeOfAudacity : AbstractSubclass
{
    ...
    public CollegeOfAudacity()
    {
        ...
        var powerAudaciousWhirl = FeatureDefinitionPowerBuilder
            ...
            .SetGuiPresentation($"FeatureSet{Name}AudaciousWhirl", Category.Feature, hidden: true)
        ...
        Subclass = CharacterSubclassDefinitionBuilder
            .Create(Name)
            .SetGuiPresentation(Category.Subclass, Sprites.GetSprite(Name, Resources.CollegeOfAudacity, 256))
